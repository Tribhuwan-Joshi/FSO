...
describe("total likes", () => {
  ...
  test("when list has only one blog is equal to its likes", () => {
...
describe("favourite blog", () => {
  ...
  test("of single element is empty object", () => {
...
describe("mostBlog", () => {
  ...
  test("of single element list is author with 1 count", () => {
    assert.deepStrictEqual(listHelper.mostBlogs([blogs[0]]), {
      author: "Michael Chan",
      blogs: 1,
    });
  });
  test("of lengthy list is correct", () => {
...
describe("mostLikes", () => {
  ...
  test("for single element list is author with 1 count", () => {
    assert.deepStrictEqual(listHelper.mostLikes([blogs[0]]), {
      author: "Michael Chan",
      likes: 7,
    });
  });
  test("for lengthy list is correct", () => {
